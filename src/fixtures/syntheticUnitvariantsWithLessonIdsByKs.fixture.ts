...
const baseSyntheticUnitvariantsWithLessonIdsByKsFixture: SyntheticUnitvariantsWithLessonIdsByKs =
  {
    base_slug: "base-slug",
    unit_slug: "unit-slug",
...
export const syntheticUnitvariantsWithLessonIdsByKsFixture = ({
  ...
  ...baseSyntheticUnitvariantsWithLessonIdsByKsFixture,
  ...overrides,
});
...
export const syntheticUnitvariantsWithLessonIdsByKsFixtureCamel = ({
  ...
  camelcaseKeys(
    ...
    { deep: true },
  ) as SyntheticUnitvariantsWithLessonIdsByKsCamel;
