...
const baseSyntheticUnitvariantsWithLessonIdsByYearsFixture: SyntheticUnitvariantsWithLessonIdsByYears =
  {
    base_slug: "base-slug",
    unit_slug: "unit-slug",
...
export const syntheticUnitvariantsWithLessonIdsByYearsFixture = ({
  ...
  ...baseSyntheticUnitvariantsWithLessonIdsByYearsFixture,
  ...overrides,
});
...
export const syntheticUnitvariantsWithLessonIdsByYearsFixtureCamel = ({
  ...
  camelcaseKeys(
    ...
    { deep: true },
  ) as SyntheticUnitvariantsWithLessonIdsByYearsCamel;
